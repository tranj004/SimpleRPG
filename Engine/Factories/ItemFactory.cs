...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            ...
            BuildWeapon(1999, "Divine Blade", 1000000, 1000, 9999);

            BuildWeapon(2001, "Snake fangs", 0, 0, 2);
            BuildWeapon(2002, "Rat claws", 0, 0, 2);
            BuildWeapon(2003, "Spider fangs", 0, 0, 4);

            BuildHealingItem(3001, "Granola bar", 5, 10);
